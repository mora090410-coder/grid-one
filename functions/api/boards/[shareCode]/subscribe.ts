  ...
  try {
    const emailResponse = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        html: `<div style="font-family:Arial,sans-serif;max-width:560px;margin:auto;color:#13212E"><h1 style="font-size:28px">Verify winner emails</h1><p>${escapeHtml(claim.participant_name)}, confirm this address to receive one email if this board name wins Q1, halftime, Q3, or Final.</p><p><a href="${verifyUrl}" style="display:inline-block;background:#13212E;color:#F6F7F5;padding:14px 20px;text-decoration:none;font-weight:700">Verify email</a></p><p style="color:#5B6670">GridOne tracks the board. It does not collect square money, hold funds, settle payments, or pay winners.</p></div>`,
      }),
