...
export const primaryLink = `${geometry} group g-cta bg-action text-action-text font-semibold hover:bg-action-hover ${primaryLift} ${press}`;
export const quietLink = `${geometry} g-chip bg-panel border border-hairline text-fg hover:bg-panel-hover ${lift} ${press}`;
