...
/** Friendly one-line version for the top of the homepage. The exact boundary stays in the FAQ and footer. */
export const MONEY_LINE = 'You collect the money your way. GridOne keeps the board.';
