    ...
    <div className="oa-root min-h-screen bg-broadcast-white text-ink font-sans selection:bg-gold/30 flex flex-col overflow-x-hidden">
      ...
      <main className="mx-auto w-full max-w-4xl px-5 py-24">
        ...
        <article className="prose prose-lg max-w-none">
          ...
          <p className="text-ink/80 leading-relaxed mb-6">If your group is small and in one room, paper can survive. The moment people are remote, distracted, or checking from their phone, a digital football squares board wins fast.</p>
