                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-white/10 pb-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className="px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wide text-gray-400 hover:text-white border border-white/10 hover:border-white/30 transition-all"
                        >
                            Log Out
                        </button>
